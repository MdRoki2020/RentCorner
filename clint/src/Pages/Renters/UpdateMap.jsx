...
const UpdateMap = () => {
    ...
    const handleSubmit = async (event) => {
      ...
      try {
        const res = await axios.post('http://localhost:8000/api/v1/UpdateLocation', newPlace);
    ...
    <Fragment>
        <div className='container'>
            ...
            <div className='col-md-12'>
                ...
                <div className='row'>
                    <div className='col-sm-3'>
                        <h3 className='mt-3'><FaMapMarkedAlt/></h3>
                    </div>
                    <div className='col-sm-9'>
                    <div className='posterText'>
                    <h2>Update Your Location</h2>
                    <p><AiTwotoneEnvironment/> All World !</p>
                    </div>
                    </div>
                </div>
                </div>
            ...
            <div className='mapinfo'>
                ...
                <button className='btn btn-info shadow my-4' type="submit">Update Place</button>
                </form>
